...
contract GuardianNFT is IMalevolent, ERC721 , Ownable ,RoyaltiesV2Impl  {
     ...
     using Strings for uint256;
      Counters.Counter private _tokenIds;
       address public auction;
        ...
        uint256 private rarity1 = 3;//1 
       

        uint256 public rarity1_limit = 6;//2450;//1
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return "https://ipfs.io/ipfs/QmVmvWg9x1zouFY3pADsXP9ta36YmSzNkUPtjmHQsM1Jho?filename=1.json";
    }
    ...
    function inc_nftType() private returns(uint256){
        require(rarity1<rarity1_limit,"all Guardian angels minted");
        return rarity1++;
    }
